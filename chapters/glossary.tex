...
\newacronym{sirna}{siRNA}{short interfering \gls{rna}}
...
\newacronym{trbp}{TRBP}{TRA \gls{rna}-binding protein}
\newacronym{pact}{PACT}{protein activator of protein kinase PKR}
\newacronym{risc}{RISC}{\gls{rna}-induced silencing complex}
...
\newacronym{rits}{RITS}{\gls{rna}-induced transcriptional silencing complex}
\newacronym{rdrc}{RDRC}{\gls{rna}-dependent \gls{rna} polymerase complex}
\newacronym{pkr}{PKR}{\gls{rna}-dependent protein kinase pathway}
...
\newacronym{shrna}{shRNA}{short hairpin \gls{rna}}
