...
\begin{figure}
  ...
  \vspace{5mm}
  \caption[Decision tree for \textit{Listeria} infection scoring.]{The decision tree for \textit{Listeria} infection scoring is based on a channel recording InlC localization and intensity instead of targeting the bacteria themselves. Despite the values indicating coverage of each of the parameter sets not summing to unity, the list is exhaustive. The discrepancy is caused by rounding.}
\end{figure}
