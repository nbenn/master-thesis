...
% do within well-binary comparisons
% further feature augmentation: us neighbors to build clusters 
%   -> use cluster size
% use infection 
% when only targetin ifected cells, need to aggregate wells, problem of ote's