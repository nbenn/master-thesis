<<who-deaths_top-causes, eval=TRUE, echo=FALSE, fig.width=12, fig.height=6, fig.cap="Relative frequencies of death causes in 2012 by World Bank income groups. Binning is based on Gross National Income (GNI) per capita and the thresholds are \\$1\'045 or less for low income, \\$1046 to \\$4125 for lower-middle, \\$4126 to \\$12745 for upper-middle and \\$12746 or more for high income economies. The data was obtained from the \\cite{WHO2012}.">>=
...
ggplot(aggr, aes(x=Region, y=scaled, fill=Cause)) +
  ...
  scale_fill_brewer(name="Cause of death", palette="Spectral",
                    labels=c("Infectious and parasitic\ndiseases",
                             "Maternal and perinatal\nconditions",
                             "Nutritional deficiencies", "Malignant neoplasms",
                             "Diabetes mellitus", "Neurological conditions",
